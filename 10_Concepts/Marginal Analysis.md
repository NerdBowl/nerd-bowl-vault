...
---
### Marginal Analysis
This framework applies to decisions regarding the *extent* or *level* of an activity, e.g. "How much should I do?".
...
- **Correction:** An activity should be increased only if the _marginal_ benefit of the specific next unit exceeds its _marginal_ cost. It is possible for average benefit to be high while marginal benefit is lower than marginal cost.
