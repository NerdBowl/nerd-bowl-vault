...
#### Schelling’s Insight (Limiting Options)
Economist Thomas Schelling demonstrated that voluntarily **limiting one's own options** can be strategically advantageous .
- **The Logic:** By removing the option to "defect" or "back down," a player changes the expectations of their opponent.
- **The Kidnapper Parable:** A kidnapper wants to release a victim but fears the victim will go to the police. The victim cannot _credibly_ promise silence because, once free, they have no incentive to keep the promise .
