...
1. Comprehensively explain key concepts of advanced probabilistic inference and causality.
2. Comparatively analyse strengths and weaknesses of advanced inference procedures.
3. Express real-world problems as probabilistic models.
4. Relate real-world problems to suitable techniques.
5. Evaluate self-implemented probabilistic inference techniques.
...
- Written Exam (70%)
- Assignment applying modelling methods (15%)
- Assignment empirically evaluating methods (15%)

Non-graded assessment:

- Practice exam (week 5)
- Feedback on the first assignment (week 6)
- Feedback on the second assignment (week 8)
